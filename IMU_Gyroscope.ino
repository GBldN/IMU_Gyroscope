 ...
 * 
 * Ce programme permet d'acquérir les valeurs mesurées par une centrale inertielle, calculer les angles de ROULIS, TANGAGE et "LACETS" et les comparer avec des valeurs mesurées 
 * par des capteurs de rotation dans une platine prototype de type gyroscope.
 * 
 *   - La centrale utilisée est une Grove_IMU_6 DOF : https://wiki.seeedstudio.com/Grove-6-Axis_AccelerometerAndGyroscope/
 * 
 * 
 * Une vidéo du programme en situation est disponible
 *  
 * version=1.0
